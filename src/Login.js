...
export default function Login() {
  ...
  return (
    <div className="login-wrapper">
      ...
      <div className="login-card glass-panel animated-fade-in">
        ...
        >
          ...
          {isProcessing ? "Подождите..." : "Войти через Google"}
        </button>

        {error && (
          <div style={{marginTop: "20px", color: "#fca5a5", fontSize: "0.9rem", textAlign: "center", padding: "12px", backgroundColor: "rgba(239, 68, 68, 0.15)", borderRadius: "8px", border: "1px solid rgba(239, 68, 68, 0.3)"}}>
            {error}
          </div>
        )}
