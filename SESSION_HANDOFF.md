...
- As of 2026-06-10, deadline write validation rejects or ignores dates outside `2020..2100`. API/client contracts, command-service task creation/deadline updates, and the standalone MCP add/set-deadline tools reject `0020-02-07`; capture/Telegram heuristic extraction drops invalid dates instead of writing them.
