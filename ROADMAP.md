...
- Ensure web merge logic and MCP writes do not conflict.
  ...
  - 2026-06-08: `npm run deploy:mcp-server` is a dry-run-first deploy helper for syncing `services/mcp-server/src/index.js` to Hetzner with local/server syntax checks, remote backup, PM2 restart, and health/auth-boundary postchecks. It does not copy secrets or live data.
