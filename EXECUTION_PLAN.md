...
- As of 2026-06-02, the post-add next-state strip is the only visible return action in that partial-draft state; the older bottom exit action is hidden there to avoid duplicate exits.
