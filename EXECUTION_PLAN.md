...
- As of 2026-06-02, Progress Decision Safety also includes `Copy QA packet`, a combined non-mutating export containing both the QA baseline and Decision Trace with one timestamp. It is the primary copy action; the separate baseline/trace buttons remain secondary diagnostics.
