...
- As of 2026-06-01, Progress Decision Safety includes `Copy QA baseline`, a non-mutating way to copy or display auth mode, user id, planner counts, outbox counts, mission, delivery, Engine decision, report, and event counts before a live QA pass.
